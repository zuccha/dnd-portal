...
CREATE TABLE IF NOT EXISTS public.creatures (
  ...
  speed_walk smallint DEFAULT '0'::smallint NOT NULL,
  speed_fly smallint DEFAULT '0'::smallint NOT NULL,
  speed_swim smallint DEFAULT '0'::smallint NOT NULL,
  speed_climb smallint DEFAULT '0'::smallint NOT NULL,
  speed_burrow smallint DEFAULT '0'::smallint NOT NULL,
