...
CREATE TABLE IF NOT EXISTS public.creatures (
  ...
  exp integer DEFAULT '0'::integer NOT NULL,
  has_lair boolean DEFAULT false NOT NULL,
  ...
  lair_legendary_actions_count smallint DEFAULT '0'::smallint NOT NULL,
  lair_exp integer DEFAULT '0'::integer NOT NULL,
  ...
  legendary_actions_count smallint DEFAULT '0'::smallint NOT NULL,
  passive_perception smallint DEFAULT '0'::smallint NOT NULL,
  pb smallint DEFAULT '2'::smallint NOT NULL,
  ...
  telepathy_range integer DEFAULT '0'::integer NOT NULL,
