...
ALTER FUNCTION public.create_item_modifier(p_source_id uuid, p_lang text, p_item_modifier jsonb, p_item_modifier_translation jsonb) OWNER TO postgres;
...
ALTER FUNCTION public.update_item_modifier(p_id uuid, p_lang text, p_item_modifier jsonb, p_item_modifier_translation jsonb) OWNER TO postgres;
