...
ALTER FUNCTION public.create_creature_tag(p_campaign_id uuid, p_lang text, p_creature_tag jsonb, p_creature_tag_translation jsonb) OWNER TO postgres;

GRANT ALL ON FUNCTION public.create_creature_tag(p_campaign_id uuid, p_lang text, p_creature_tag jsonb, p_creature_tag_translation jsonb) TO anon;
GRANT ALL ON FUNCTION public.create_creature_tag(p_campaign_id uuid, p_lang text, p_creature_tag jsonb, p_creature_tag_translation jsonb) TO authenticated;
GRANT ALL ON FUNCTION public.create_creature_tag(p_campaign_id uuid, p_lang text, p_creature_tag jsonb, p_creature_tag_translation jsonb) TO service_role;
...
ALTER FUNCTION public.fetch_creature_tags(p_campaign_id uuid, p_langs text[], p_filters jsonb, p_order_by text, p_order_dir text) OWNER TO postgres;

GRANT ALL ON FUNCTION public.fetch_creature_tags(p_campaign_id uuid, p_langs text[], p_filters jsonb, p_order_by text, p_order_dir text) TO anon;
GRANT ALL ON FUNCTION public.fetch_creature_tags(p_campaign_id uuid, p_langs text[], p_filters jsonb, p_order_by text, p_order_dir text) TO authenticated;
GRANT ALL ON FUNCTION public.fetch_creature_tags(p_campaign_id uuid, p_langs text[], p_filters jsonb, p_order_by text, p_order_dir text) TO service_role;
