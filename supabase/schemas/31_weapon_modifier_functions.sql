...
ALTER FUNCTION public.fetch_weapon_modifier(p_id uuid) OWNER TO postgres;
...
ALTER FUNCTION public.fetch_weapon_modifiers(p_source_id uuid, p_langs text[], p_filters jsonb, p_order_by text, p_order_dir text) OWNER TO postgres;
