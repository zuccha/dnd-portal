...
ADD COLUMN required_attunement_slots smallint DEFAULT 0 NOT NULL,
ADD CONSTRAINT equipments_required_attunement_slots_check CHECK (required_attunement_slots >= 0);

ALTER TABLE public.equipment_translations
ADD COLUMN attunement_notes text;

ALTER TYPE public.equipment_row
ADD ATTRIBUTE required_attunement_slots smallint CASCADE;

ALTER TYPE public.equipment_row
ADD ATTRIBUTE attunement_notes jsonb CASCADE;

ALTER TYPE public.item_row
ADD ATTRIBUTE required_attunement_slots smallint CASCADE;

ALTER TYPE public.item_row
ADD ATTRIBUTE attunement_notes jsonb CASCADE;

ALTER TYPE public.armor_row
ADD ATTRIBUTE required_attunement_slots smallint CASCADE;

ALTER TYPE public.armor_row
ADD ATTRIBUTE attunement_notes jsonb CASCADE;

ALTER TYPE public.weapon_row
ADD ATTRIBUTE required_attunement_slots smallint CASCADE;

ALTER TYPE public.weapon_row
ADD ATTRIBUTE attunement_notes jsonb CASCADE;

ALTER TYPE public.tool_row
ADD ATTRIBUTE required_attunement_slots smallint CASCADE;
...
AS $$
  ...
  LEFT JOIN (
    SELECT
      t.resource_id AS id,
      jsonb_object_agg(t.lang, t.utilize) AS utilize
    FROM public.tool_translations t
