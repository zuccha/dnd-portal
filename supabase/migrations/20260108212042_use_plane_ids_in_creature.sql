...
drop type "public"."creature_row";
  ...
  create table "public"."creature_planes" (
...
CREATE UNIQUE INDEX creature_planes_pkey ON public.creature_planes USING btree (creature_id, plane_id);

CREATE INDEX idx_creature_planes_creature_id ON public.creature_planes USING btree (creature_id);

CREATE INDEX idx_creature_planes_plane_id ON public.creature_planes USING btree (plane_id);

alter table "public"."creature_planes" add constraint "creature_planes_pkey" PRIMARY KEY using index "creature_planes_pkey";

alter table "public"."creature_planes" add constraint "creature_planes_creature_id_fkey" FOREIGN KEY (creature_id) REFERENCES public.creatures(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creature_planes" validate constraint "creature_planes_creature_id_fkey";

alter table "public"."creature_planes" add constraint "creature_planes_plane_id_fkey" FOREIGN KEY (plane_id) REFERENCES public.planes(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creature_planes" validate constraint "creature_planes_plane_id_fkey";
...
grant delete on table "public"."creature_planes" to "anon";

grant insert on table "public"."creature_planes" to "anon";

grant references on table "public"."creature_planes" to "anon";

grant select on table "public"."creature_planes" to "anon";

grant trigger on table "public"."creature_planes" to "anon";

grant truncate on table "public"."creature_planes" to "anon";

grant update on table "public"."creature_planes" to "anon";

grant delete on table "public"."creature_planes" to "authenticated";

grant insert on table "public"."creature_planes" to "authenticated";

grant references on table "public"."creature_planes" to "authenticated";

grant select on table "public"."creature_planes" to "authenticated";

grant trigger on table "public"."creature_planes" to "authenticated";

grant truncate on table "public"."creature_planes" to "authenticated";

grant update on table "public"."creature_planes" to "authenticated";

grant delete on table "public"."creature_planes" to "service_role";

grant insert on table "public"."creature_planes" to "service_role";

grant references on table "public"."creature_planes" to "service_role";

grant select on table "public"."creature_planes" to "service_role";

grant trigger on table "public"."creature_planes" to "service_role";

grant truncate on table "public"."creature_planes" to "service_role";

grant update on table "public"."creature_planes" to "service_role";
...
using ((public.can_read_resource(creature_id) AND public.can_read_resource(plane_id)));
