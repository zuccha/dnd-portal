drop policy "Creators and GMs can create new creature translations" on "public"."creature_translations";

drop policy "Creators and GMs can delete creature translations" on "public"."creature_translations";

drop policy "Creators and GMs can update creature translations" on "public"."creature_translations";
...
alter table "public"."creature_translations" drop constraint "creature_translations_creature_id_fkey";

alter table "public"."creatures" drop constraint "creature_campaign_id_fkey";

drop function if exists "public"."can_edit_creature_translation"(p_creature_id uuid);

drop function if exists "public"."can_read_creature_translation"(p_creature_id uuid);
...
alter table "public"."creature_translations" drop constraint "creature_translations_pkey";

alter table "public"."creatures" drop constraint "creature_pkey";

drop index if exists "public"."creature_pkey";

drop index if exists "public"."creature_translations_pkey";

alter table "public"."creature_translations" rename column "creature_id" to "resource_id";

alter table "public"."creature_translations" drop column "name";

alter table "public"."creature_translations" drop column "page";

alter table "public"."creatures" drop column "campaign_id";

alter table "public"."creatures" rename column "id" to "resource_id";

alter table "public"."creatures" drop column "visibility";

CREATE UNIQUE INDEX creature_pkey ON public.creatures USING btree (resource_id);

CREATE UNIQUE INDEX creature_translations_pkey ON public.creature_translations USING btree (resource_id, lang);

alter table "public"."creature_translations" add constraint "creature_translations_pkey" PRIMARY KEY using index "creature_translations_pkey";

alter table "public"."creatures" add constraint "creature_pkey" PRIMARY KEY using index "creature_pkey";

alter table "public"."creature_translations" add constraint "creature_translations_resource_id_fkey" FOREIGN KEY (resource_id) REFERENCES public.creatures(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creature_translations" validate constraint "creature_translations_resource_id_fkey";

alter table "public"."creatures" add constraint "creature_resource_id_fkey" FOREIGN KEY (resource_id) REFERENCES public.resources(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creatures" validate constraint "creature_resource_id_fkey";

set check_function_bodies = off;

create type "public"."creature_row" as ("campaign_id" uuid, "campaign_name" text, "id" uuid, "kind" public.resource_kind, "visibility" public.campaign_role, "name" jsonb, "page" jsonb, "ac" smallint, "ability_cha" smallint, "ability_con" smallint, "ability_dex" smallint, "ability_int" smallint, "ability_str" smallint, "ability_wis" smallint, "ability_proficiencies" public.creature_ability[], "alignment" public.creature_alignment, "condition_immunities" public.creature_condition[], "condition_resistances" public.creature_condition[], "condition_vulnerabilities" public.creature_condition[], "cr" numeric, "damage_immunities" public.damage_type[], "damage_resistances" public.damage_type[], "damage_vulnerabilities" public.damage_type[], "habitats" public.creature_habitat[], "hp" smallint, "hp_formula" text, "initiative" smallint, "passive_perception" smallint, "size" public.creature_size, "skill_expertise" public.creature_skill[], "skill_proficiencies" public.creature_skill[], "speed_burrow" integer, "speed_climb" integer, "speed_fly" integer, "speed_swim" integer, "speed_walk" integer, "treasures" public.creature_treasure[], "type" public.creature_type, "actions" jsonb, "bonus_actions" jsonb, "gear" jsonb, "languages" jsonb, "legendary_actions" jsonb, "planes" jsonb, "reactions" jsonb, "senses" jsonb, "traits" jsonb);
...
CREATE TRIGGER enforce_creature_resource_kind BEFORE INSERT OR UPDATE ON public.creatures FOR EACH ROW EXECUTE FUNCTION public.validate_creature_resource_kind();
