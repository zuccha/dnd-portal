...
DROP FUNCTION public.fetch_character_classes(
  p_campaign_id uuid,
  p_langs text[],
  p_filters jsonb,
  p_order_by text,
...
alter type "public"."die_type" rename to "die_type__old_version_to_be_dropped";

create type "public"."die_type" as enum ('d4', 'd6', 'd8', 'd10', 'd12', 'd20');

alter table "public"."character_classes" alter column hp_die type "public"."die_type" using hp_die::text::"public"."die_type";

drop type "public"."die_type__old_version_to_be_dropped";
