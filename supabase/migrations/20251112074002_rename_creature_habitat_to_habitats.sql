-- Rename habitat column to habitats in creatures table and update RPC functions

-- Rename the column in the creatures table
ALTER TABLE "public"."creatures"
RENAME COLUMN "habitat" TO "habitats";

-- Remove functions, since we change their signatures/return types
DROP FUNCTION "public"."fetch_creatures"(uuid, text[], jsonb, text, text);

-- Update fetch_creatures RPC function with renamed habitat field
...
-- Update fetch_creature to use habitats
...
-- Update create_creature to use habitats
...
-- Update update_creature to use habitats
