...
drop type "public"."creature_row";
  ...
  create table "public"."creature_equipment" (
...
CREATE UNIQUE INDEX creature_equipment_entry_uniq ON public.creature_equipment USING btree (creature_id, equipment_id) NULLS NOT DISTINCT;

CREATE UNIQUE INDEX creature_equipment_pkey ON public.creature_equipment USING btree (id);

CREATE INDEX idx_creature_equipment_creature_id ON public.creature_equipment USING btree (creature_id);

CREATE INDEX idx_creature_equipment_equipment_id ON public.creature_equipment USING btree (equipment_id);

alter table "public"."creature_equipment" add constraint "creature_equipment_pkey" PRIMARY KEY using index "creature_equipment_pkey";

alter table "public"."creature_equipment" add constraint "creature_equipment_creature_id_fkey" FOREIGN KEY (creature_id) REFERENCES public.creatures(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creature_equipment" validate constraint "creature_equipment_creature_id_fkey";

alter table "public"."creature_equipment" add constraint "creature_equipment_entry_uniq" UNIQUE using index "creature_equipment_entry_uniq";

alter table "public"."creature_equipment" add constraint "creature_equipment_equipment_id_fkey" FOREIGN KEY (equipment_id) REFERENCES public.equipments(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."creature_equipment" validate constraint "creature_equipment_equipment_id_fkey";
...
grant delete on table "public"."creature_equipment" to "anon";

grant insert on table "public"."creature_equipment" to "anon";

grant references on table "public"."creature_equipment" to "anon";

grant select on table "public"."creature_equipment" to "anon";

grant trigger on table "public"."creature_equipment" to "anon";

grant truncate on table "public"."creature_equipment" to "anon";

grant update on table "public"."creature_equipment" to "anon";

grant delete on table "public"."creature_equipment" to "authenticated";

grant insert on table "public"."creature_equipment" to "authenticated";

grant references on table "public"."creature_equipment" to "authenticated";

grant select on table "public"."creature_equipment" to "authenticated";

grant trigger on table "public"."creature_equipment" to "authenticated";

grant truncate on table "public"."creature_equipment" to "authenticated";

grant update on table "public"."creature_equipment" to "authenticated";

grant delete on table "public"."creature_equipment" to "service_role";

grant insert on table "public"."creature_equipment" to "service_role";

grant references on table "public"."creature_equipment" to "service_role";

grant select on table "public"."creature_equipment" to "service_role";

grant trigger on table "public"."creature_equipment" to "service_role";

grant truncate on table "public"."creature_equipment" to "service_role";

grant update on table "public"."creature_equipment" to "service_role";
  ...
  for insert
  to authenticated
with check ((public.can_edit_resource(creature_id) AND ((equipment_id IS NULL) OR public.can_read_resource(equipment_id))));
...
using ((public.can_read_resource(creature_id) AND ((equipment_id IS NULL) OR public.can_read_resource(equipment_id))));
