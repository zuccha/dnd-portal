-- Change CR from smallint to numeric and add initiative_passive field

-- Change cr column type from smallint to numeric (to support fractional CRs like 1/8, 1/4, 1/2)
ALTER TABLE "public"."creatures"
ALTER COLUMN "cr" TYPE numeric USING "cr"::numeric;

-- Add initiative_passive field to creatures table
ALTER TABLE "public"."creatures"
ADD COLUMN "initiative_passive" "text" DEFAULT ''::"text" NOT NULL;

-- Remove functions to recreate with updated signatures
DROP FUNCTION "public"."fetch_creatures"(uuid, text[], jsonb, text, text);

-- Update fetch_creatures RPC function with new cr type and initiative_passive field
...
-- Update fetch_creature to include initiative_passive
...
-- Update create_creature to include initiative_passive
...
begin
  ...
  insert into public.creatures (
    ...
    initiative, initiative_passive, passive_perception, ability_proficiencies, skill_proficiencies,
    ...
    r.initiative, r.initiative_passive, r.passive_perception, r.ability_proficiencies, r.skill_proficiencies,
...
-- Update update_creature to include initiative_passive
