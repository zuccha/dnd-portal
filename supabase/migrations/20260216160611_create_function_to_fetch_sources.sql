create type "public"."source_type" as enum ('core', 'module', 'campaign');

alter table "public"."sources" add column "type" public.source_type not null default 'campaign'::public.source_type;
