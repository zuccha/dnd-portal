drop policy "Creators and GMs can create new weapon translations" on "public"."weapon_translations";

drop policy "Creators and GMs can delete weapon translations" on "public"."weapon_translations";

drop policy "Creators and GMs can update weapon translations" on "public"."weapon_translations";
...
alter table "public"."weapon_translations" drop constraint "weapon_translations_weapon_id_fkey";

alter table "public"."weapons" drop constraint "weapons_campaign_id_fkey";

drop function if exists "public"."can_edit_weapon_translation"(p_weapon_id uuid);

drop function if exists "public"."can_read_weapon_translation"(p_weapon_id uuid);
...
alter table "public"."weapon_translations" drop constraint "weapon_translations_pkey";

alter table "public"."weapons" drop constraint "weapons_pkey";

drop index if exists "public"."weapon_translations_pkey";

drop index if exists "public"."weapons_pkey";

alter table "public"."armor_translations" alter column "resource_id" drop default;

alter table "public"."armors" alter column "resource_id" drop default;

alter table "public"."weapon_translations" drop column "name";

alter table "public"."weapon_translations" drop column "notes";

alter table "public"."weapon_translations" drop column "page";

alter table "public"."weapon_translations" rename column "weapon_id" to "resource_id";

alter table "public"."weapons" drop column "campaign_id";

alter table "public"."weapons" drop column "cost";

alter table "public"."weapons" drop column "created_at";

alter table "public"."weapons" rename column "id" to "resource_id";

alter table "public"."weapons" drop column "magic";

alter table "public"."weapons" drop column "visibility";

alter table "public"."weapons" drop column "weight";

CREATE UNIQUE INDEX weapon_translations_pkey ON public.weapon_translations USING btree (resource_id, lang);

CREATE UNIQUE INDEX weapons_pkey ON public.weapons USING btree (resource_id);

alter table "public"."weapon_translations" add constraint "weapon_translations_pkey" PRIMARY KEY using index "weapon_translations_pkey";

alter table "public"."weapons" add constraint "weapons_pkey" PRIMARY KEY using index "weapons_pkey";

alter table "public"."weapon_translations" add constraint "weapon_translations_resource_id_fkey" FOREIGN KEY (resource_id) REFERENCES public.weapons(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."weapon_translations" validate constraint "weapon_translations_resource_id_fkey";

alter table "public"."weapons" add constraint "weapons_resource_id_fkey" FOREIGN KEY (resource_id) REFERENCES public.equipments(resource_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."weapons" validate constraint "weapons_resource_id_fkey";

set check_function_bodies = off;

create type "public"."weapon_row" as ("campaign_id" uuid, "campaign_name" text, "id" uuid, "kind" public.resource_kind, "visibility" public.campaign_role, "name" jsonb, "page" jsonb, "cost" integer, "magic" boolean, "weight" integer, "damage" text, "damage_type" public.damage_type, "damage_versatile" text, "mastery" public.weapon_mastery, "melee" boolean, "properties" public.weapon_property[], "range_long" integer, "range_short" integer, "ranged" boolean, "type" public.weapon_type, "ammunition" jsonb, "notes" jsonb);
