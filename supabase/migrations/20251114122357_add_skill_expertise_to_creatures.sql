-- Add skill_expertise field to creatures table and update RPC functions

-- Add skill_expertise column to creatures table (same type as skill_proficiencies)
ALTER TABLE "public"."creatures"
ADD COLUMN "skill_expertise" "public"."creature_skill"[] NOT NULL DEFAULT '{}';

-- Remove function to recreate with updated signature
DROP FUNCTION "public"."fetch_creatures"(uuid, text[], jsonb, text, text);

-- Update fetch_creatures RPC function to include skill_expertise field
...
-- Update fetch_creature to include skill_expertise
...
-- Update create_creature to include skill_expertise
...
-- Update update_creature to include skill_expertise
