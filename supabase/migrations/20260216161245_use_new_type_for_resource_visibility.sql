...
ALTER TABLE public.resources
  ...
  TYPE public.resource_visibility
  USING (
    CASE visibility
      WHEN 'player'::public.campaign_role THEN 'public'::public.resource_visibility
      ELSE 'private'::public.resource_visibility
    END
  );

ALTER TABLE public.resources
  ALTER COLUMN visibility
  SET DEFAULT 'private'::public.resource_visibility;
...
create type "public"."character_class_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "armor_proficiencies" public.armor_type[], "hp_die" public.die_type, "primary_abilities" public.creature_ability[], "saving_throw_proficiencies" public.creature_ability[], "skill_proficiencies_pool" public.creature_skill[], "skill_proficiencies_pool_quantity" smallint, "starting_equipment_entries" jsonb, "tool_proficiency_ids" uuid[], "weapon_proficiencies" public.weapon_type[], "spell_ids" uuid[], "armor_proficiencies_extra" jsonb, "weapon_proficiencies_extra" jsonb);

create type "public"."creature_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "ac" smallint, "ability_cha" smallint, "ability_con" smallint, "ability_dex" smallint, "ability_int" smallint, "ability_str" smallint, "ability_wis" smallint, "ability_proficiencies" public.creature_ability[], "alignment" public.creature_alignment, "blindsight" integer, "condition_immunities" public.creature_condition[], "condition_resistances" public.creature_condition[], "condition_vulnerabilities" public.creature_condition[], "cr" numeric, "darkvision" integer, "damage_immunities" public.damage_type[], "damage_resistances" public.damage_type[], "damage_vulnerabilities" public.damage_type[], "habitats" public.creature_habitat[], "hp" smallint, "hp_formula" text, "initiative" smallint, "language_additional_count" smallint, "passive_perception" smallint, "size" public.creature_size, "skill_expertise" public.creature_skill[], "skill_proficiencies" public.creature_skill[], "speed_burrow" integer, "speed_climb" integer, "speed_fly" integer, "speed_swim" integer, "speed_walk" integer, "treasures" public.creature_treasure[], "equipment_entries" jsonb, "language_ids" uuid[], "language_scope" public.language_scope, "tag_ids" uuid[], "plane_ids" uuid[], "telepathy_range" integer, "tremorsense" integer, "truesight" integer, "type" public.creature_type, "actions" jsonb, "bonus_actions" jsonb, "gear" jsonb, "legendary_actions" jsonb, "reactions" jsonb, "traits" jsonb);

create type "public"."creature_tag_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb);

create type "public"."eldritch_invocation_row" as ("id" uuid, "source_id" uuid, "source_code" text, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "min_warlock_level" smallint, "description" jsonb, "prerequisite" jsonb);

create type "public"."equipment_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "cost" integer, "magic" boolean, "rarity" public.equipment_rarity, "weight" integer, "notes" jsonb);

create type "public"."item_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "cost" integer, "magic" boolean, "rarity" public.equipment_rarity, "weight" integer, "type" public.item_type, "notes" jsonb);

create type "public"."language_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "rarity" public.language_rarity, "origin" jsonb);

create type "public"."plane_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "category" public.plane_category, "alignments" public.creature_alignment[]);

create type "public"."resource_row" as ("id" uuid, "source_id" uuid, "source_code" text, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb);

create type "public"."spell_row" as ("source_id" uuid, "source_code" text, "id" uuid, "kind" public.resource_kind, "visibility" public.resource_visibility, "image_url" text, "name" jsonb, "name_short" jsonb, "page" jsonb, "casting_time" public.spell_casting_time, "casting_time_value" integer, "character_class_ids" uuid[], "concentration" boolean, "duration" public.spell_duration, "duration_value" integer, "level" smallint, "material" boolean, "range" public.spell_range, "range_value" integer, "ritual" boolean, "school" public.spell_school, "somatic" boolean, "verbal" boolean, "description" jsonb, "materials" jsonb, "upgrade" jsonb);
