...
DECLARE
  v_id uuid;
BEGIN
  v_id := public.create_creature_without_hover(
    p_source_id,
    p_lang,
    p_creature,
  ...
  SET hover = coalesce((p_creature->>'hover')::boolean, false)
...
AS $$
BEGIN
  PERFORM public.update_creature_without_hover(
    p_id,
    p_lang,
    p_creature,
    p_creature_translation
