...
ADD COLUMN version public.source_version
DEFAULT 'dnd5_5'::public.source_version NOT NULL;

DROP FUNCTION IF EXISTS public.fetch_sources(public.source_type[]);

CREATE FUNCTION public.fetch_sources(p_types public.source_type[] DEFAULT NULL)
...
-- Generated from current schema files to add source_version to fetch row types and resource fetch functions.

DROP TYPE IF EXISTS public.resource_row CASCADE;
...
DROP TYPE IF EXISTS public.character_subclass_row CASCADE;
...
DROP TYPE IF EXISTS public.tool_row CASCADE;
...
DROP TYPE IF EXISTS public.weapon_row CASCADE;
...
DROP TYPE IF EXISTS public.equipment_row CASCADE;
...
DROP TYPE IF EXISTS public.armor_row CASCADE;
...
DROP TYPE IF EXISTS public.creature_row CASCADE;
...
DROP TYPE IF EXISTS public.creature_tag_row CASCADE;
...
DROP TYPE IF EXISTS public.eldritch_invocation_row CASCADE;
...
DROP TYPE IF EXISTS public.language_row CASCADE;
...
DROP TYPE IF EXISTS public.spell_row CASCADE;
...
DROP TYPE IF EXISTS public.item_row CASCADE;
...
DROP TYPE IF EXISTS public.plane_row CASCADE;
...
DROP TYPE IF EXISTS public.character_class_row CASCADE;
