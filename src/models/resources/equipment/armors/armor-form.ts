...
export const armorFormDataSchema = equipmentFormDataSchema.extend({
  armor_class_includes_cha_modifier: z.boolean().default(false),
  armor_class_includes_con_modifier: z.boolean().default(false),
  armor_class_includes_dex_modifier: z.boolean().default(false),
  armor_class_includes_int_modifier: z.boolean().default(false),
  armor_class_includes_str_modifier: z.boolean().default(false),
  armor_class_includes_wis_modifier: z.boolean().default(false),
  armor_class_max_cha_modifier: z.number().default(0),
  armor_class_max_con_modifier: z.number().default(0),
  armor_class_max_dex_modifier: z.number().default(0),
  armor_class_max_int_modifier: z.number().default(0),
  armor_class_max_str_modifier: z.number().default(0),
  armor_class_max_wis_modifier: z.number().default(0),
  armor_class_modifier: z.number().default(0),
  base_armor_class: z.number().default(10),
  disadvantage_on_stealth: z.boolean().default(false),
  required_cha: z.number().default(0),
  required_con: z.number().default(0),
  required_dex: z.number().default(0),
  required_int: z.number().default(0),
  required_str: z.number().default(0),
  required_wis: z.number().default(0),
  type: armorTypeSchema.default("light"),
});
