...
export const itemModifierFormDataSchema = equipmentModifierFormDataSchema.extend({});
...
export function itemModifierFormDataToResource(
  ...
  return equipmentModifierFormDataToResource(data, lang) as Partial<ItemModifier>;
}
...
export const itemModifierForm = createForm("item_modifier", itemModifierFormDataSchema.parse);
