...
export const palettes: Record<PaletteName, Palette> = {
  ...
  black: /*     */ palette("#E6E6E6", "#DADADA", "#1F1F1F", "#111111"),
  ...
  gray: /*      */ palette("#E8E6E2", "#DBD7D1", "#7C756F", "#56504B"),
  ...
  magenta: /*   */ palette("#FFE6F1", "#FFC7E0", "#D81B82", "#A1145F"),
  mauve: /*     */ palette("#F1E6F7", "#DCC5EC", "#7F5A9A", "#5A3F70"),
  moss: /*      */ palette("#DCE2D8", "#C9D2C3", "#5B6F5C", "#3F4D40"),
  ...
  sage: /*      */ palette("#E7EDE8", "#CDD9CF", "#7A917E", "#5B6E5F"),
  salmon: /*    */ palette("#FFE4DC", "#FFC5B7", "#E06F62", "#B5544A"),
  silver: /*    */ palette("#E3E8EC", "#D0D7DE", "#8A949E", "#636C75"),
  slate: /*     */ palette("#E3E8EE", "#CBD4DD", "#5E6F86", "#445061"),
