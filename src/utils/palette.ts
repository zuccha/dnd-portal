...
export const palettes: Record<PaletteName, Palette> = {
  ...
  gray: /*      */ palette("#F2F1EE", "#DBD7D1", "#7C756F", "#56504B"),
  ...
  moss: /*      */ palette("#E5E9E2", "#C9D2C3", "#5B6F5C", "#3F4D40"),
  ...
  silver: /*    */ palette("#EEF2F5", "#D0D7DE", "#8A949E", "#636C75"),
  slate: /*     */ palette("#E9EDF1", "#CBD4DD", "#5E6F86", "#445061"),
